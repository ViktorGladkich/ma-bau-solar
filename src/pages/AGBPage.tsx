  ...
  return (
    <>
      <SEO
        ...
        description="Allgemeine Geschäftsbedingungen der MA Bau GmbH - Vertragsbedingungen für Photovoltaik-Montage, Trockenbau und Handwerksarbeiten."
        url="https://mabaugmbh.de/agb"
        type="website"
      />
          ...
          <div className="space-y-12 text-gray-600 font-light leading-relaxed">
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                Photovoltaik-Montage, Trockenbau und allgemeine
                Handwerksarbeiten.
              </p>
              <p className="mb-4">
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                sind. Ein Vertrag kommt erst durch schriftliche
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                Auftragsbestätigung bzw. dem geschlossenen Vertrag.
                Nachträgliche Änderungen oder Ergänzungen bedürfen der
              ...
              <p className="mb-4">
                <strong>Trockenbau und Handwerksarbeiten:</strong> Die
                Ausführung erfolgt fachgerecht nach den anerkannten Regeln der
                Technik. Der Auftraggeber stellt die erforderlichen Anschlüsse
                (Strom, Wasser etc.) zur Verfügung.
              </p>
              <p>
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                Transport, Verpackung und Versicherung werden gesondert
              ...
              <ul className="list-disc list-inside mb-4 space-y-2 ml-4">
                <li>
                  Bei Auftragserteilung: 30% Anzahlung auf die Gesamtsumme
                </li>
                <li>
              ...
              <p className="mb-4">
                ...
                Abzug zur Zahlung fällig. Bei Zahlungsverzug werden
                Verzugszinsen in Höhe von 9 Prozentpunkten über dem
            ...
            <section>
              ...
              <p>
                ...
                ausgeschlossen, es sei denn, dem Auftragnehmer fällt Vorsatz
            ...
            <section>
              ...
              <p>
                Verzögerungen aufgrund nicht erfüllter Mitwirkungspflichten
                gehen zu Lasten des Auftraggebers und können zu Mehrkosten
                führen.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                Etwaige Mängel sind bei der Abnahme zu rügen. Unwesentliche
            ...
            <section>
              ...
              <p className="mb-4">
                Für Mängel der erbrachten Leistungen haftet der Auftragnehmer
                nach den gesetzlichen Vorschriften des Werkvertragsrechts (§§
                633 ff. BGB). Die Gewährleistungsfrist beträgt 2 Jahre ab
                Abnahme, soweit nicht gesetzlich längere Fristen vorgeschrieben
                sind.
              </p>
              <p className="mb-4">
                <strong>Mängelansprüche:</strong> Der Auftraggeber hat bei
                Mängeln zunächst Anspruch auf Nacherfüllung (Nachbesserung oder
                Neuherstellung). Der Auftragnehmer ist berechtigt, zweimal
                nachzubessern.
              </p>
              <p className="mb-4">
                Schlägt die Nacherfüllung fehl, kann der Auftraggeber nach
                seiner Wahl Minderung verlangen oder vom Vertrag zurücktreten.
                Bei nur unerheblichen Mängeln besteht kein Rücktrittsrecht.
              </p>
              <p className="mb-4">
                <strong>Ausschluss der Gewährleistung:</strong> Die
              ...
              <ul className="list-disc list-inside mb-4 space-y-1 ml-4">
                ...
                <li>
                  Änderungen oder Reparaturen durch Dritte ohne Zustimmung
                </li>
            ...
            <section>
              ...
              <p className="mb-4">
                Für sonstige Schäden haftet der Auftragnehmer nur bei Vorsatz
                und grober Fahrlässigkeit sowie bei der Verletzung wesentlicher
            ...
            <section>
              ...
              <p>
                ...
                Vorbehaltsware durch den Auftragnehmer gelten nicht als
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                Auftraggebers ausschließlich zur Vertragsabwicklung und gemäß
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                Geschäftsbeziehung erlangten vertraulichen Informationen geheim
                zu halten und nur zur Vertragserfüllung zu verwenden.
              </p>
              <p>
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                des Auftragnehmers. Sie dürfen ohne ausdrückliche Zustimmung
            ...
            <section>
              ...
              <p>
                Die Abtretung von Rechten und Pflichten aus dem Vertrag durch
            ...
            <section>
              ...
              <p>
                ...
                Sitz des Auftragnehmers (Dresden). Der Auftragnehmer ist jedoch
                auch berechtigt, am allgemeinen Gerichtsstand des Auftraggebers
                zu klagen.
              </p>
            </section>
