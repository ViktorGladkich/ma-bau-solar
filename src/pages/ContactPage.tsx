              ...
              <div className="space-y-6">
                <details className="group border-b border-primary/10 pb-6">
                  ...
                  <p className="mt-4 text-gray-600 leading-relaxed">
                    Wir beginnen mit einer kostenlosen Erstberatung, analysieren
                    Ihre Flächen und erstellen ein individuelles Konzept. Nach
                    der Planung erfolgt die fachgerechte Montage durch unsere
                    erfahrenen Teams.
                  </p>
                </details>
                ...
                <details className="group border-b border-primary/10 pb-6">
                  ...
                  <p className="mt-4 text-gray-600 leading-relaxed">
                    Wir realisieren Projekte auf Freiflächen sowie auf Hallen-,
                    Industrie- und Gewerbedächern – sowohl bei Neubauten als
                    auch im Bestand.
                  </p>
                </details>
                ...
                <details className="group border-b border-primary/10 pb-6">
                  ...
                  <p className="mt-4 text-gray-600 leading-relaxed">
                    ...
                    direkt an unter +49 176 32187740. Wir melden uns zeitnah bei
                    Ihnen.
                  </p>
                </details>
              </div>
