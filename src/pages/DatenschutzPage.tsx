    ...
    <div className="bg-secondary min-h-screen pt-32 pb-32">
      <div className="container mx-auto px-6 md:px-12 max-w-4xl">
        ...
        <div className="space-y-12 text-gray-600 font-light leading-relaxed">
          ...
          {/* 2. Hosting */}
          <section>
            <h2 className="text-lg font-bold text-primary mb-4">2. Hosting</h2>
            <p className="mb-4">
          ...
          <section>
            ...
            <p className="mb-4">
              Auf unserer Website setzen wir einen KI-gestützten Chatbot ein, um
              Ihnen eine schnelle und effiziente Kommunikation zu ermöglichen.
              Der Chatbot nutzt Google Gemini AI zur Verarbeitung Ihrer
              Anfragen.
            </p>
            ...
            <p>
              Die Chat-Nachrichten werden zur Verarbeitung an Google (Gemini AI)
              übermittelt. Google verarbeitet diese Daten gemäß ihrer
